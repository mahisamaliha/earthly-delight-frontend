  ...
  <div>
    ...
    <section class="container pt-50 pb-50">
      <div class="dashboard-section">
        ...
        <div class="dashboard-address menu-item">
          <h4 class="menu-item--title">Billing Address</h4>
          <h4 class="sub-title">Mahisa Maliha</h4>
          <p class="address">
            From your account dashboard. you can easily check & view your recent
            orders, manage your shipping and billing addresses and edit your
            password and account details
          </p>
          <p class="contact">Mobile: 012-345-6789</p>
          <button><i class="las la-edit"></i>Edit Address</button>
        </div>
      </div>
...
export default {
  ...
  async created() {
    ...
    const response = await this.callApi("get", "/app/auth_user");
