        ...
        <div class="dashboard-menu">
          ...
          <ul class="dashboard-menu--list">
            <li class="dashboard-menu--list---item">
              <nuxt-link class="menu-link" aria-current="page" to="/dashboard-profile"><i class="las la-icons"></i>
                <h4>Dashboard</h4>
              </nuxt-link>
            </li>
            <li class="dashboard-menu--list---item">
              <nuxt-link class="menu-link active" aria-current="page" to="/"><i class="las la-shopping-bag"></i>
                <h4>My Orders</h4>
              </nuxt-link>
            </li>
            <li class="dashboard-menu--list---item">
              <nuxt-link class="menu-link" aria-current="page" to="/dashboard-signOut"><i class="las la-sign-out-alt"></i>
                <h4>Sign Out</h4>
              </nuxt-link>
            </li>
          </ul>
        ...
        <template>
          <div class="dashboard-myOrder menu-item">
            ...
            <div class="dashboard-myOrder--list">
              <div class="dashboard-myOrder--list---item" v-for="order in orders" :key="order.id">
                <div class="order-details">
                  <h5 class="title">{{ order.order_details.product.productName }}</h5>
                ...
                <div class="pay-details">
                  ...
                  <div class="pay-details--button">
                    ...
                    <button class="view">
                      <nuxt-link :to="`/dashboard-orderView/${order.id}`">View</nuxt-link>
                    </button>
                  </div>
