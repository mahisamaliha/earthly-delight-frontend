  ...
  <footer class="bg-primary">
    <div class="container">
      <div class="footer-customer">
        <div class="row">
          <div class="footer-customer__item">
            <i class="las la-truck"></i>
            <div class="footer-customer__item--content">
              <h3>Free Shipping Orders $60+</h3>
          ...
          <div class="col-lg-4">
            <div class="footer-info__left">
              <div class="footer-info__item">
                <h3>Subscribe</h3>
                <p>Enter email address get $20 off your first order</p>
    ...
    <div class="container">
      <div class="footer-copyright">
        <p>Copyright © 2022 earthlydelight.com All Rights Reserved</p>
      </div>
    </div>
  </footer>
</template>
